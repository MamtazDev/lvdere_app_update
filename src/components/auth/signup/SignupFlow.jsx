...
export default function SignupFlow({ onSubmit, loading }) {
  ...
  const [val2d, setVal2d] = useState(false);
  ...
  const validate = () => {
    ...
    if (!phoneNumber.match(phone_validation.validation.pattern.value)) {
      errors.phoneNumber = phone_validation.validation.pattern.message;
    }
...
const FormStep1 = ({
  ...
  console.log(validationErrors, 'kkk');
